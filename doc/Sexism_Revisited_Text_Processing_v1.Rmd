...
### THIS FILE HAS JUST BEEN SLIGHTLY ADAPTED BY ME (TIM) IN STEP 2
...
# exclude "she", etc. from stop_words to later being able to identify songs about women/men
remove <- c("he", "she", "his", "her", "shed", "hed", "shell", "hell", "shes", "hes", "him", "hers")
stop_words <- stop_words[! stop_words %in% remove]
...
```{r export data}
save(dt_lyrics, file="../output/processed_lyrics_gender.RData")
```
